...
gambarku = Image.open(r"/Users/alihza/Documents/TUGAS/Semester 5/prak fungsional/Tugas/Modul 6/2.jpeg")

# TODO 2: Ubah gambar menjadi hitam-putih
# hint: kalian bisa gunakan fungsi convert()s
gambarBW = gambarku.convert("L")

# TODO 3: Tambahkan text sesuai kriteria.
draw = ImageDraw.Draw(gambarBW)
direktoriFont = r"/Users/alihza/Documents/TUGAS/Semester 5/prak fungsional/Tugas/Modul 6/RED BURGER.otf"  # Ganti dengan direktori font yang sudah kamu unduh
size = 24
font = ImageFont.truetype(direktoriFont, size)
text = "Nama: Al Ihza Ahmad Sabita\nNIM: 202110370311377"
